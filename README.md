...
![ReproShot evidence summary from an actual failing demo capture](docs/reproshot.svg)
...
The SVG is generated from the committed demo capture. The examples intentionally fail so the full capture path can be tested.
